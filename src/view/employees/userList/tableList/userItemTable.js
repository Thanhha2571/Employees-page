    ...
    return (
        <tr className="tr-item">
            <td className="td-item">
                <h2 className="item-table-field">
                    <Link className="img-table-item-block" to={`viewprofile/${uuid}`}>
                        <img className="img-table-item" src={imageUrl} alt="" />
                    </Link>
                    <Link className="name-table-item" to={`viewprofile/${uuid}`}>{fullname}
                        <span className="role-title">{roleObj?.title}</span>
                    </Link>
                </h2>
            </td>
            ...
            <td className="td-item-action">
                ...
                {openMenu === uuid && (
                    <div className="menu-edit-delete-user-table-view">
